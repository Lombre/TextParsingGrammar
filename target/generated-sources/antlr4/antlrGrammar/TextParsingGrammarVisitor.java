...
public interface TextParsingGrammarVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link TextParsingGrammarParser#normalWord}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNormalWord(TextParsingGrammarParser.NormalWordContext ctx);
	/**
	 * Visit a parse tree produced by {@link TextParsingGrammarParser#nonWord}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNonWord(TextParsingGrammarParser.NonWordContext ctx);
}